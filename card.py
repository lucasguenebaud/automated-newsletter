                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                              ...
                              <tr>
                                <td align="center" class="hund ripplelink" width="600">
                                  <img align="center" width="600" style="border-radius: 3px 3px 0px 0px; width: 100%; max-width: 600px!important" class="hund" src="THIS_IS_WHERE_IMAGE_GOES">
                                </td>
                              </tr>
                              <!-- END HEADER IMAGE -->
                              <!-- START BODY COPY -->
                                    ...
                                    <tr>
                                      <td>
                                        <table border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td align="left" style="border-radius: 3px;" bgcolor="#THIS_IS_COLOR">
                                              <a class="button raised" href="THIS_IS_WHERE_THE_LINK_GOES" target="_blank" style="font-size: 14px; line-height: 14px; font-weight: 500; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 10px 25px; border: 1px solid #THIS_IS_COLOR; display: inline-block;">THIS_IS_WHERE_THE_TYPE_GOES</a>
                                            </td>
                                          </tr>
                                        </table>
                                      </td>
